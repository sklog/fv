<div class="m"><h2 class="house-header">СТОИМОСТЬ МОНТАЖА КАНАЛИЗАЦИИ</h2><hr size="2" color="orange"><br>
<div class="castom">
<table class="tab" style="text-align: left; width: 100%;" border="1"
 cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      <td><p class="m">монтаж труб канализации ПВХ (на 1 точке)</p></td>
      <td><p class="m">3 500 руб</p></td>
    </tr>
    <tr>
      <td><p class="m">замена канализационного (фанового) стояка</p></td>
